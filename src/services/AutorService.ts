...
export class AutorService {
    constructor(private readonly autorRepository: AutorRepository = new AutorRepository()) {}
    ...
    async remover(id: number): Promise<void> {
        ...
        if (possuiVinculo) {
            throw new AppError('Não é possível remover o autor pois há livros vinculados a ele.');
        }
