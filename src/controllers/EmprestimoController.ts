...
export class EmprestimoController {
    ...
    private async registrarEmprestimo(): Promise<void> {
        ...
        const dataInput = readlineSync.question('Data prevista de devolução AAAA-MM-DD (opcional): ');
        ...
        const emprestimo = await this.emprestimoService.registrarEmprestimo({ livroId, clienteId, dataDevolucaoPrevista });
